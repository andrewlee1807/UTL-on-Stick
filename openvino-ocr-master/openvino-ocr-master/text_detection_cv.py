...
class PixelLinkDecoder():
    ...
    """
    def __init__(self):
        self.td = cv2.dnn.readNet(config.PATH_TEXT_DETECTION_MODEL_XML, config.PATH_TEXT_DETECTION_MODEL_BIN)
        self.td.setPreferableTarget(cv2.dnn.DNN_TARGET_MYRIAD)
    ...
    def inference(self, img):
        blob = cv2.dnn.blobFromImage(img, 1, (1280, 768)) # (1280,768) (800,480)
